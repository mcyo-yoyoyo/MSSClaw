...
export const SEED_INTERNAL_OFFICE_SCENES = [
  {
    id: 'write', label: '写报告用云笔记', english: 'WRITE',
    description: '周报、方案、工作总结边写边沉淀，首选云笔记', icon: 'fa-file-lines',
    visible: true, toolIds: ['tool-hw-cloudnote'], toolBlurbs: { 'tool-hw-cloudnote': '写报告与会议纪要' },
  },
  {
    id: 'capture', label: '开会纪要用云笔记', english: 'CAPTURE',
    description: '会后自动成稿，可回看、可执行、可继续改', icon: 'fa-pen-to-square',
    visible: true, toolIds: ['tool-hw-cloudnote'], toolBlurbs: { 'tool-hw-cloudnote': '写报告与会议纪要' },
  },
  {
    id: 'search', label: '查制度用W3智能搜索', english: 'SEARCH',
    description: '制度、入口、内部资料一搜即达，不必在群里问人', icon: 'fa-magnifying-glass',
    visible: true, toolIds: ['tool-hw-w3-qa'], toolBlurbs: { 'tool-hw-w3-qa': '查制度与内部入口' },
  },
  {
    id: 'ask', label: '个人Skill用员工助手', english: 'ASK',
    description: '日常提问、总结、润色，当个人助手用就对了', icon: 'fa-comments',
    visible: true, toolIds: ['tool-hw-assistant'], toolBlurbs: { 'tool-hw-assistant': '个人日常 Skill' },
  },
  {
    id: 'read', label: '读材料用员工助手', english: 'READ',
    description: '快速读懂文档与报告，提炼观点、数据和风险', icon: 'fa-book-open',
    visible: true, toolIds: ['tool-hw-assistant'], toolBlurbs: { 'tool-hw-assistant': '个人日常 Skill' },
  },
  {
    id: 'specialist', label: '专项答疑用小鲁班', english: 'SPECIALIST',
    description: '深入某一业务领域连续追问，比通用问答更贴场景', icon: 'fa-screwdriver-wrench',
    visible: true, toolIds: ['tool-hw-xiaoluban'], toolBlurbs: { 'tool-hw-xiaoluban': '专项业务答疑' },
  },
  {
    id: 'intel', label: '情报监测用员工助手', english: 'INTELLIGENCE',
    description: '围绕关注主题筛选研判，让信息从人找变成主动送', icon: 'fa-binoculars',
    visible: false, toolIds: ['tool-hw-assistant'], toolBlurbs: { 'tool-hw-assistant': '个人日常 Skill' },
  },
  {
    id: 'knowledge', label: '建知识库用员工助手', english: 'KNOWLEDGE',
    description: '把沉淀资料变成可问答的知识，团队里真正被用起来', icon: 'fa-database',
    visible: false, toolIds: ['tool-hw-assistant'], toolBlurbs: { 'tool-hw-assistant': '个人日常 Skill' },
  },
  {
    id: 'agent', label: '拆任务用员工助手', english: 'EXECUTE',
    description: '给出目标后拆解任务、调用工具并推进交付', icon: 'fa-robot',
    visible: false, toolIds: ['tool-hw-assistant'], toolBlurbs: { 'tool-hw-assistant': '个人日常 Skill' },
  },
];
