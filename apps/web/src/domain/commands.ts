...
const NAV_COMMANDS = (h: AppCommandHandlers): AppCommand[] => [
  ...
  },
  {
    ...
    label: '外部工具精选',
    icon: 'fa-globe',
    keywords: '外部工具精选 外部工具 货架 SaaS 找案例 外链',
  ...
  },
  {
    ...
    label: '内部办公推荐',
    icon: 'fa-building',
    keywords: '内部办公推荐 内部工具 集市 connector 货架',
  ...
  },
  {
    ...
    label: '配置Agent',
    icon: 'fa-robot',
    keywords: '配置Agent 配置专家 Agent 运营 agent studio',
    view: 'agents',
    run: () => h.goto('agents'),
  },
  {
    ...
    label: '配置Skill',
    icon: 'fa-cube',
    keywords: '配置Skill 配置技能 Skill 运营 skill',
    view: 'skills',
    run: () => h.goto('skills'),
  },
  {
