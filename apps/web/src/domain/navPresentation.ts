...
export const NAV_PRESET_LABELS: Record<NavPresetId, { title: string; description: string }> = {
  ...
  standard: {
    title: '标准能力',
    description: 'MVP 基础上增加工具 · 知识 · 自动化',
  },
  full: {
    title: '完整产品',
...
/** MVP演示：首页/任务/案例/专家/技能 + 门户运营/组织权限（快捷设置为侧栏固定入口） */
const MVP_ENABLED: Record<AppView, boolean> = {
  ...ALL_FALSE,
  home: true,
  task: true,
  messages: true,
