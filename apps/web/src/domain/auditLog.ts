...
export const SEED_AUDIT_LOGS: AuditLogEntry[] = [
  {
    ...
    module: 'members',
    detail: '激活成员 bruce@huawei.com',
    userName: 'Mcyo',
    userEmail: 'mcyo@huawei.com',
    role: 'super_admin',
    deptIds: ['quality'],
    regionId: null,
  },
  {
    ...
    module: 'members',
    detail: '邀请 jacky@huawei.com 为能力开发',
    userName: 'Mcyo',
    userEmail: 'mcyo@huawei.com',
    role: 'super_admin',
    deptIds: ['quality'],
