...
export const PROTOTYPE_KB_DOCS: PrototypeKbDocument[] = [
  ...
  { id: 'kb-review-sop', title: 'Amazon/Lazada 评论分析 SOP', desc: '多语种评论采集、聚类口径、MX/EU 平台差异说明', collection: 'ecommerce', type: 'PDF', size: '1.2 MB', pages: 22, clearance: 'L2', indexed: true, chunks: 142, tags: ['评论', '电商'], updatedAt: '2026-07-06', author: '电商运营' },
