...
export const PROTOTYPE_AGENTS: PrototypeAgentSeed[] = [
  {
    ...
    ownerRegionIds: ['latam', 'mea', 'russia'],
    author: '华为 MSS',
    published: true,
    invokes: 4280,
  ...
  },
  {
    ...
    bizLine: '电商/服务',
    homeTag: 'ecommerce',
    ownerDeptIds: ['ecommerce', 'service', 'mkt'],
    ownerRegionIds: ['apac', 'europe'],
    author: '华为 MSS',
    published: true,
    invokes: 2780,
  ...
  },
  {
    ...
    bizLine: '零售/电商',
    homeTag: 'retail',
    ownerDeptIds: ['retail', 'ecommerce'],
    ownerRegionIds: ['latam', 'russia'],
    author: '华为 MSS',
    published: true,
    invokes: 3680,
    ...
    chatId: 'marketing',
    icon: 'fa-store',
    color: 'from-neutral-600 to-zinc-800',
  },
  {
    ...
    bizLine: '渠道/电商/GTM',
    homeTag: 'gtm',
    ownerDeptIds: ['gtm', 'channel', 'ecommerce'],
    ownerRegionIds: ['latam', 'mea', 'europe', 'russia', 'apac'],
    author: '华为 MSS',
    published: true,
    invokes: 4120,
